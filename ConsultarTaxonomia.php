...
$json=array();
		...
		$consulta=$conexion->query("SELECT nombreZona, descripcionZona1, lugarZona, nombreDepto, nombreMunicipio,  latitudZona, longitudZona, habitatZona FROM zonas z INNER JOIN municipios m  ON
